...
inline Matrix2::Matrix2(float xx, float xy, float yx, float yy) { set(xx, xy, yx, yy); }
...
inline Matrix3::Matrix3(float xx, float xy, float xz, float yx, float yy, float yz, float zx,
                        float zy, float zz) {
...
inline void Matrix3::set(float xx, float xy, float xz, float yx, float yy, float yz, float zx,
                         float zy, float zz) {
    m[0] = xx;
    m[1] = xy;
    m[2] = xz;
...
inline Matrix4::Matrix4(float xx, float xy, float xz, float xw, float yx, float yy, float yz,
...
inline void Matrix4::set(float xx, float xy, float xz, float xw, float yx, float yy, float yz,
                         float yw, float zx, float zy, float zz, float zw, float wx, float wy,
                         float wz, float ww) {
    m[0] = xx;
    m[1] = xy;
